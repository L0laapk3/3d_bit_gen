import {
  ...
  createConfig, duplicateConfig, renameConfig, deleteConfig, updateConfig,
...
function renderConfigList() {
  ...
  configs.forEach(c => {
    ...
    copyBtn.className = 'config-rename-btn';
    ...
    item.addEventListener('click', (e) => {
      if (e.target.closest('.config-rename-btn, .config-delete-btn')) return;
